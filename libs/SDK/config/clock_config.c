...
- {id: RTC_CLK.outFreq, value: 16 MHz}
...
- {id: SPLLDIV1_CLK.outFreq, value: 128 MHz}
- {id: SPLLDIV2_CLK.outFreq, value: 128 MHz}
- {id: SPLL_CLK_OUT.outFreq, value: 128 MHz}
- {id: SYS_CLK.outFreq, value: 48 MHz}
- {id: TRACE_CLK.outFreq, value: 48 MHz}
settings:
- {id: SCG.SPLL_mul.scale, value: '16'}
sources:
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        .spllConfig =
        {
            ...
            .mult = (uint8_t)SCG_SPLL_CLOCK_MULTIPLY_BY_16,/* Multiply Factor is 16 */
            .src = 0U,
